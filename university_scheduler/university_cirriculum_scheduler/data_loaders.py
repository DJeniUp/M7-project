...
CSV_DIR = Path(__file__).resolve().parent / "csvs"
TEACHER_AVAIL_FILE = CSV_DIR / "teacher_availability.csv"
PREREQS_FILE = CSV_DIR / "prereqs_CSDS.csv"
COURSE_TEACHER_FILE = CSV_DIR / "course_teacher.csv"
CELEBRITY_FILE = CSV_DIR / "celebrity_courses.csv"
